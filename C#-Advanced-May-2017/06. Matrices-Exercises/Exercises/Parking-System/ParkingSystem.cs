...
class ParkingSystem
{
    static void Main()
    {
        ...
        var rowsCount = int.Parse(mainTokens[0]);
        ...
        while ((input = Console.ReadLine()) != "stop")
        {
            ...
            {
                if (colToLeft > 0 && IsFreeSpot(parking, initialRow, colToLeft))
                {
                    spotCol = colToLeft;
                    break;
                }
                else if (colToRight < colsCount && IsFreeSpot(parking, initialRow, colToRight))
                {
                    spotCol = colToRight;
                    break;
                }

        ...
        while ((line = Console.ReadLine()) != "Print")
        {
            ...
            if (command == "Add filter")
            {
                switch (filter)
                {
                    ...
                    case "Length": lengthsCollection.Add(int.Parse(parameter)); break;

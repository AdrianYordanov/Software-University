...
INSERT Employees (FirstName, LastName, Title, Notes)
VALUES
('Pesho', 'Ivanov', 'Mr', 'Noober'),
('Mesho', 'Ivanov', 'Mr', 'Noober'),
('Klesho', 'Ivanov', 'Mr', 'Noober')

INSERT Customers (FirstName, LastName, PhoneNumber)
VALUES
...
INSERT Rooms (RoomNumber, RoomType, BedType, Rate, RoomStatus)
VALUES
...
INSERT Payments (EmployeeId, PaymentDate, AccountNumber, FirstDateOccupied, LastDateOccupied, TotalDays, AmountCharged, TaxRate, TaxAmount, PaymentTotal)
VALUES
...
INSERT Occupancies (EmployeeId, DateOccupied, AccountNumber, RoomNumber, RateApplied, PhoneCharge)
VALUES

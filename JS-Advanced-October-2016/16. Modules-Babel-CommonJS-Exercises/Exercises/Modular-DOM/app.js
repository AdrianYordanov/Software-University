// Export modules
/*
 result.BaseElement = require("./js/base-element");
 result.TitleBar = require("./js/title-bar");
 result.Footer = require("./js/footer");
 result.Article = require("./js/article");
 result.ImageArticle = require("./js/image-article");
 result.TableArticle = require("./js/table-article");
*/

let BaseElement = require("./js/base-element.js");
let TitleBar = require("./js/title-bar.js");
let Footer = require("./js/footer.js");
let Article = require("./js/article.js");
let ImageArticle = require("./js/image-article.js");
let TableArticle = require("./js/table-article.js");
